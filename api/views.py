...
# api starts here
@extend_schema(
request=VendorSerializer, # Specify the request serializer
responses={ # Specify responses for different status codes
...
# api starts here
@extend_schema(
request=PurchaseOrderSerializer, # Specify the request serializer
responses={ # Specify responses for different status codes
201: {'description': 'Vendor Created'},
400: {'description': 'Bad Request'},
404: {'description': 'Not Found'},
